 ...
 * ignored.
 **/
GPB_FINAL @interface AuthenticationRule : GPBMessage
 ...
 **/
GPB_FINAL @interface AuthProvider : GPBMessage
 ...
 **/
GPB_FINAL @interface OAuthRequirements : GPBMessage
 ...
 * [JSON Web Token (JWT)](https://tools.ietf.org/html/draft-ietf-oauth-json-web-token-32).
 **/
GPB_FINAL @interface AuthRequirement : GPBMessage
