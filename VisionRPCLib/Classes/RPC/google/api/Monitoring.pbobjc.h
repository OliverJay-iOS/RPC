 ...
 **/
GPB_FINAL @interface MonitoringRoot : GPBRootObject
@end

#pragma mark - Monitoring

typedef GPB_ENUM(Monitoring_FieldNumber) {
  Monitoring_FieldNumber_ProducerDestinationsArray = 1,
  Monitoring_FieldNumber_ConsumerDestinationsArray = 2,
};
 ...
 **/
GPB_FINAL @interface Monitoring : GPBMessage
 ...
 **/
@property(nonatomic, readwrite, strong, null_resettable) NSMutableArray<Monitoring_MonitoringDestination*> *producerDestinationsArray;
 ...
 **/
@property(nonatomic, readwrite, strong, null_resettable) NSMutableArray<Monitoring_MonitoringDestination*> *consumerDestinationsArray;
...
typedef GPB_ENUM(Monitoring_MonitoringDestination_FieldNumber) {
  Monitoring_MonitoringDestination_FieldNumber_MonitoredResource = 1,
  Monitoring_MonitoringDestination_FieldNumber_MetricsArray = 2,
};
 ...
 **/
GPB_FINAL @interface Monitoring_MonitoringDestination : GPBMessage
