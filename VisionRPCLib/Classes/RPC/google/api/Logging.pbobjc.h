 ...
 **/
GPB_FINAL @interface LoggingRoot : GPBRootObject
@end

#pragma mark - Logging

typedef GPB_ENUM(Logging_FieldNumber) {
  Logging_FieldNumber_ProducerDestinationsArray = 1,
  Logging_FieldNumber_ConsumerDestinationsArray = 2,
};
 ...
 *         - library.googleapis.com/activity_history
 **/
GPB_FINAL @interface Logging : GPBMessage
 ...
 **/
@property(nonatomic, readwrite, strong, null_resettable) NSMutableArray<Logging_LoggingDestination*> *producerDestinationsArray;
 ...
 **/
@property(nonatomic, readwrite, strong, null_resettable) NSMutableArray<Logging_LoggingDestination*> *consumerDestinationsArray;
...
typedef GPB_ENUM(Logging_LoggingDestination_FieldNumber) {
  Logging_LoggingDestination_FieldNumber_LogsArray = 1,
  Logging_LoggingDestination_FieldNumber_MonitoredResource = 3,
};
 ...
 **/
GPB_FINAL @interface Logging_LoggingDestination : GPBMessage
