...
typedef GPB_ENUM(Http_FieldNumber) {
  Http_FieldNumber_RulesArray = 1,
};
 ...
 **/
GPB_FINAL @interface Http : GPBMessage

/** A list of HTTP rules for configuring the HTTP REST API methods. */
@property(nonatomic, readwrite, strong, null_resettable) NSMutableArray<HttpRule*> *rulesArray;
...
typedef GPB_ENUM(HttpRule_FieldNumber) {
  HttpRule_FieldNumber_Selector = 1,
