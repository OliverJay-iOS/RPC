 ...
 **/
GPB_FINAL @interface DiscoverRoot : GPBRootObject
@end
...
GPB_FINAL @interface Endpoint : GPBMessage
...
GPB_FINAL @interface PingMessage : GPBMessage
...
GPB_FINAL @interface PongMessage : GPBMessage
...
GPB_FINAL @interface FindNeighbours : GPBMessage
...
GPB_FINAL @interface Neighbours : GPBMessage
...
GPB_FINAL @interface BackupMessage : GPBMessage
