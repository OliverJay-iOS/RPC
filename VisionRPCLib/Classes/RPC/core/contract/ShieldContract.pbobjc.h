...
/** The number of items in @c authenticationPathsArray without causing the array to be created. */
...
/** The number of items in @c indexArray without causing the array to be created. */
...
/** The number of items in @c filledArray without causing the array to be created. */
...
/** The number of items in @c vouchersArray without causing the array to be created. */
