...
typedef GPB_ENUM(AssetIssueContract_FieldNumber) {
  ...
  AssetIssueContract_FieldNumber_VsNum = 6,
  ...
  AssetIssueContract_FieldNumber_FreeAssetPhotonLimit = 22,
  AssetIssueContract_FieldNumber_PublicFreeAssetPhotonLimit = 23,
  AssetIssueContract_FieldNumber_PublicFreeAssetPhotonUsage = 24,
  AssetIssueContract_FieldNumber_PublicLatestFreePhotonTime = 25,
...
@property(nonatomic, readwrite) int32_t vsNum;
...
@property(nonatomic, readwrite) int64_t freeAssetPhotonLimit;

@property(nonatomic, readwrite) int64_t publicFreeAssetPhotonLimit;

@property(nonatomic, readwrite) int64_t publicFreeAssetPhotonUsage;

@property(nonatomic, readwrite) int64_t publicLatestFreePhotonTime;
