...
typedef GPB_ENUM(SmartContract_FieldNumber) {
  ...
  SmartContract_FieldNumber_OriginEntropyLimit = 8,
...
@property(nonatomic, readwrite) int64_t originEntropyLimit;
...
typedef GPB_ENUM(CreateSmartContract_FieldNumber) {
  ...
  CreateSmartContract_FieldNumber_Type = 5,
  CreateSmartContract_FieldNumber_RlpData = 6,
};
...
typedef GPB_ENUM(TriggerSmartContract_FieldNumber) {
  ...
  TriggerSmartContract_FieldNumber_Type = 7,
  TriggerSmartContract_FieldNumber_RlpData = 8,
};
...
typedef GPB_ENUM(UpdateEntropyLimitContract_FieldNumber) {
  UpdateEntropyLimitContract_FieldNumber_OwnerAddress = 1,
  UpdateEntropyLimitContract_FieldNumber_ContractAddress = 2,
  UpdateEntropyLimitContract_FieldNumber_OriginEntropyLimit = 3,
};

GPB_FINAL @interface UpdateEntropyLimitContract : GPBMessage
