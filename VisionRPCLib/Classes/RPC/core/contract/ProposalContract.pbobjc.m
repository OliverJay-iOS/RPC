...
GPBObjCClassDeclaration(ProposalCreateContract);

#pragma mark - ProposalContractRoot

@implementation ProposalContractRoot
...
#pragma mark - ProposalContractRoot_FileDescriptor

static GPBFileDescriptor *ProposalContractRoot_FileDescriptor(void) {
  ...
  if (!descriptor) {
    ...
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:[ProposalApproveContract class]
                                     rootClass:[ProposalContractRoot class]
                                          file:ProposalContractRoot_FileDescriptor()
                                        fields:fields
  ...
  if (!descriptor) {
    static GPBMessageFieldDescription fields[] = {
      ...
      },
      {
        ...
        .dataTypeSpecific.clazz = Nil,
        .number = ProposalCreateContract_FieldNumber_StringParameters,
        .hasIndex = GPBNoHasBit,
        .offset = (uint32_t)offsetof(ProposalCreateContract__storage_, stringParameters),
        .flags = GPBFieldMapKeyInt64,
